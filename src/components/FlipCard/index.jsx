        ...
        <GridRow>
            ...
            <Card onClick={flipCards}>
              ...
              <CardBack>
                <CardDescription>
                  ...
                  treats them" and to portray "what happens to the world without
                  them".
                </CardDescription>
              </CardBack>
            </Card>
          ...
          <GridColumn sm="6" lg="4">
            <Card onClick={flipCards}>
              ...
              <CardBack>
                <CardDescription>
                  The core idea for the book came to her after a 1943 telephone
                  conversation with a friend, who asserted that Rand owed it to
                  her readers to write fiction about her philosophy.
                </CardDescription>
              </CardBack>
            </Card>
          </GridColumn>
            ...
            <Card onClick={flipCards}>
              ...
              <CardBack>
                <CardDescription>
                  ...
                  Legislature" instead of Congress and a "Head of State" instead
                  of a President.
                </CardDescription>
              </CardBack>
            </Card>
